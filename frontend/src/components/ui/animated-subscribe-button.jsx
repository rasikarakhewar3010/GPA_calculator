    ...
    (<AnimatePresence mode="wait">
      {isSubscribed ? (
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit items-center justify-center overflow-hidden rounded-lg bg-slate-900 px-6 text-slate-50 dark:bg-slate-50 dark:text-slate-900",
            className
          )}
          onClick={(e) => {
        ...
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-slate-900 px-6 text-slate-50 dark:bg-slate-50 dark:text-slate-900",
            className
          )}
          onClick={(e) => {
